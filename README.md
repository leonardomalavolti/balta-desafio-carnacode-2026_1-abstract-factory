...
No desafio **Abstract Factory** eu tive que resolver um problema real
...
Uma plataforma de e-commerce precisa integrar com múltiplos gateways de
pagamento (PagSeguro, MercadoPago, Stripe) e cada gateway tem
componentes específicos (Processador, Validador, Logger).

O código atual está muito acoplado e dificulta a adição de novos
gateways.
...
Cada gateway implementa sua própria família de objetos e sua própria
fábrica concreta:
...
-   Implementar injeção de dependência via
